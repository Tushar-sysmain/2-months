...
const ANNIVERSARY_DATE = "2025-08-06T00:00:00"
// Change this to the date you got together
const TOGETHER_DATE = "2025-06-06T00:12:10"
...
export default function Home() {
  ...
  const message = `Dear Leader Ji ❤️,
...
Happy Friendship day, Friends Here's to many more years of creating beautiful memories together.
With all my heart,
Me`
        ...
        {loading ? (
          ...
          >
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl py-1.5 font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-500 to-pink-500 mb-4 animate-gradient">
                Our First Meeting day is Coming!
              </h1>
          ...
          <>
            ...
            >
              ...
              >
                <p className="text-lg font-medium">Made with ❤️ by Ramit</p>
              </motion.footer>
            </motion.div>
          </>
        )}
